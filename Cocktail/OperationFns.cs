...
{
    /// <summary>
    ///   A collection of asynchronous operation extension methods.
    /// </summary>
    public static class OperationFns
    {
        ...
        /// <param name="onFail"> A callback to be called if the asynchronous query failed. </param>
        /// <remarks>
        ///   This overload automatically attempts to cast the results from IEnumerable to IEnumerable&lt;T&gt;.
        /// </remarks>
        /// <returns> Returns the EntityQueryOperation passed to the method's source parameter. </returns>
        ...
        /// <returns> Returns the EntityQueryOperation passed to the method's source parameter. </returns>
        /// <example>
        ///   <code title="Example" description="" lang="CS">public OperationResult GetCustomers(Action&lt;IEnumerable&lt;Customer&gt;&gt; onSuccess = null,
        ...
        /// <param name="onSuccess"> A callback to be called if the Coroutine was successful. The result object is first cast to the expected type. </param>
        ...
        /// <summary>
        ///   Extension method to process the result of a Coroutine operation without result value.
        /// </summary>
        /// <param name="source"> The CoroutineOperation returned from Coroutine.Start() </param>
        ...
        /// <example>
        ///   <code title="Example" description="" lang="CS">public OperationResult Save(Action onSuccess = null, Action&lt;Exception&gt; onFail = null)
        ///     {
        ...
        /// <returns> Returns the EntitySaveOperation passed to the method's source parameter. </returns>
        /// <example>
        ///   <code title="Example" description="" lang="CS">public OperationResult&lt;SaveResult&gt; Save(Action&lt;SaveResult&gt; onSuccess = null, Action&lt;Exception&gt; onFail = null)
        ///     {
        ///     EntitySaveOperation op = Manager.SaveChangesAsync();
        ///     return op.OnComplete(onSuccess, onFail).AsOperationResult();
        ///     }</code>
        ...
        /// <summary>
        ///   Extension method to process the result of a server method operation with result value.
        /// </summary>
        /// <param name="source"> The InvokeServerMethodOperation returned from InvokeServerMethodAsync() </param>
        /// <param name="onSuccess"> A callback to be called if the server method was successful. The result object is first cast to the expected type. </param>
