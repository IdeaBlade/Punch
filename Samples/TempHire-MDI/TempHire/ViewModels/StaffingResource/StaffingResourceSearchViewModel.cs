...
namespace TempHire.ViewModels.StaffingResource
{
    ...
    public class StaffingResourceSearchViewModel : Screen, IDiscoverableViewModel, IHarnessAware, IHandle<SavedMessage>
    {
        ...
        private StaffingResourceListItem _lastSelectionItem;
        ...
        public void Handle(SavedMessage message)
        {
            ...
            var newStaffResource = message.Entities.OfType<DomainModel.StaffingResource>().FirstOrDefault();
        ...
        public void MouseClicked()
        {
            if (_lastClickTime == null)
            {
                ...
                _lastSelectionItem = CurrentStaffingResource;
                return;
            }

            if (DateTime.Now.Subtract((DateTime)_lastClickTime).TotalMilliseconds <= 500 &&
                CurrentStaffingResource == _lastSelectionItem)
            {
